...
CREATE TABLE `centetable` (
  ...
  `yield_per_acre` varchar(30) NOT NULL,
  `in_business_since` varchar(15) NOT NULL,
  ...
  `landsize_cropselected` varchar(50) NOT NULL,
  ...
  `maize_per_kg` int(13) NOT NULL,
  `beans_per_kg` int(13) NOT NULL,
  `sesame_per_kg` int(13) NOT NULL,
  `soyabean_per_kg` int(13) NOT NULL,
  `rice_per_kg` int(13) NOT NULL,
  `millet_per_kg` int(13) NOT NULL,
  `sorghum_per_kg` int(13) NOT NULL,
  `irish_potatoes_per_kg` int(13) NOT NULL,
  `cotton_per_kg` int(13) NOT NULL,
  `sweet_potatoes_per_kg` int(13) NOT NULL,
  `sunflower_per_kg` int(13) NOT NULL,
  `ground_nuts_per_kg` int(13) NOT NULL,
  `coffee_per_kg` int(13) NOT NULL,
  `banana_per_bunch` int(13) NOT NULL,
  `cassava_per_kg` int(13) NOT NULL,
  `Did_you_apply_fertilizer` text NOT NULL,
  `Specify_the_type` text NOT NULL,
  `organic_specify` text NOT NULL,
  `Specify_other_organic` text NOT NULL,
  `inorganic_Specify` text NOT NULL,
  `use_pesticides_or_herbicides` text NOT NULL,
  `Please_specify_which_one` text NOT NULL,
  `pesticide_effectiveness` text NOT NULL,
  `crop_use` text NOT NULL,
  `involved_in_marketing` text NOT NULL,
  `sell_of_produce_Nyakyera` text DEFAULT NULL,
  `sell_of_produce_green` text NOT NULL,
  `sell_of_produce_equator` text NOT NULL,
  `sell_of_produce_liraresort` text NOT NULL,
  `sell_of_produce_cedo` text NOT NULL,
  `sell_of_produce_orum` text NOT NULL,
  `Marketlink` text NOT NULL,
  `agent_name` text NOT NULL,
  `produce_transport` text NOT NULL,
  `employ_any_farm_labour` text NOT NULL,
  `Specify_their_task` text NOT NULL,
  `Who_assisted_you` text NOT NULL,
  `How_much_did_you_pay_them` int(11) NOT NULL,
  `Are_you_aware_of_climate_shock` text NOT NULL,
  `which_ones_you_are_aware_of` text NOT NULL,
  `training_on_addressing_climate` text NOT NULL,
  `Please_specify` text NOT NULL,
  `Which_crops_for_rotation` text NOT NULL,
  `knoledge_of_rain_date` text NOT NULL,
  `heard_of_agri_insurance` text NOT NULL,
  `access_to_agri_insurance` text NOT NULL,
  `Please_specify_the_agri_insurance_type` int(11) NOT NULL,
  `Specify_the_insurance_provider` text NOT NULL,
  `fair_charge_for_insurance` int(11) NOT NULL,
  `prefer_ordinary_or_az_bunlde` text NOT NULL,
  `challenges_last_season` text NOT NULL,
  `Specify` text NOT NULL,
  `What_type_of_pests` text NOT NULL,
  `type_of_weather_and_effect` text NOT NULL,
  `Do_you_have_a_bank_account` text NOT NULL,
  `financial_access` text NOT NULL,
  `transaction_monthly_costs` text NOT NULL,
  `Specify_other_monthly_transaction_costs` text NOT NULL,
  `travel_distance` text NOT NULL,
  `specify_other_travel_distance` text NOT NULL,
  `Have_you_ever_received_credit` text NOT NULL,
  `no_of_times_borrowed` text NOT NULL,
  `loanoutstanding` text NOT NULL,
  `How_much_repayment_was_made_per_month` int(11) NOT NULL,
  `delay_time_for_repayment` text NOT NULL,
  ...
  `trainig_on_insurance` text NOT NULL,
  `Who_provided_the_training_on_insurance` text NOT NULL,
  `probs_of_using_cellphone` text NOT NULL,
  `field_officer` text NOT NULL
