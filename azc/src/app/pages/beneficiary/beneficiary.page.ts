...
// submit data to the end point when you have an active internet connection
  async SubmitData(){
    ...
    //mm_reg_status
    else if(this.mm_reg_status=="" && (this.What_type_of_phone_do_you_own !="" || this.own_a_mobile_phone=="Yes" || this.No_of_contacts > 0 || this.service_provider)){
      this.presentToast('Specify, Are you registered on Mobile Money ?'); 
    }
    else if(this.mm_reg_status !="" && (this.What_type_of_phone_do_you_own =="" || this.own_a_mobile_phone=="No" || this.No_of_contacts ==null || this.service_provider !="Others")){
